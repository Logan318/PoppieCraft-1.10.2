...
public class Jumper extends EntityMob {



    public Jumper(World worldIn) {
    ...
    protected ResourceLocation getLootTable() {
        return new ResourceLocation(References.MODID, "JumperLoot");
    }
        ...
        if (flag)
        {
            ...
            if (this.getHeldItemMainhand() == null)
            {
                ...
                if (entityIn instanceof EntityLivingBase)
                {
                    ...
                    ((EntityLivingBase)entityIn).addPotionEffect(new PotionEffect(MobEffects.LEVITATION, 200,1));
                    }
            }
        }
    ...
    public IEntityLivingData onInitialSpawn(DifficultyInstance difficulty, @Nullable IEntityLivingData livingdata)
    {
        ...
        this.removeActivePotionEffect(Potion.getPotionById(25));

        if (livingdata == null)
        {
            livingdata = new Jumper.GroupData(this.worldObj.rand.nextFloat() < net.minecraftforge.common.ForgeModContainer.zombieBabyChance, this.worldObj.rand.nextFloat() < 0.05F);
        }

        if (livingdata instanceof Jumper.GroupData)
        {
            Jumper.GroupData entityzombie$groupdata = (Jumper.GroupData)livingdata;
            boolean flag = false;
    ...
    public void onLivingUpdate()
    {
        ...
        static {
            ENTITY_PLACEMENTS.put(Jumper.class, SpawnPlacementType.ON_GROUND);
