 ...
 */
public class Sacred_table extends Block implements IMetaBlockName, ITileEntityProvider {

    public static final PropertyEnum TYPE = PropertyEnum.create("type", EnumHandler.UpgradeTypes.class);
    public static final PropertyDirection FACING = BlockHorizontal.FACING;
    public static final PropertyBool ACTIVATED = PropertyBool.create("activated");


    public Sacred_table(String unlocalizedName) {
        super(Material.ROCK);
        ...
        this.setDefaultState(this.blockState.getBaseState().withProperty(TYPE, EnumHandler.UpgradeTypes.BASIC).withProperty(FACING, EnumFacing.NORTH).withProperty(ACTIVATED, java.lang.Boolean.valueOf(false)));
    ...
    public int getMetaFromState(IBlockState state) {
        EnumHandler.UpgradeTypes type = (EnumHandler.UpgradeTypes) state.getValue(TYPE);
        return type.getID();
    }
    ...
    public IBlockState getStateFromMeta(int meta)
    {
        ...
        return this.getDefaultState().withProperty(FACING, enumfacing).withProperty(TYPE, EnumHandler.UpgradeTypes.values()[meta]);
    }
    ...
    public String getSpecialName(ItemStack stack) {
        return EnumHandler.UpgradeTypes.values()[stack.getItemDamage()].getName();
    }
