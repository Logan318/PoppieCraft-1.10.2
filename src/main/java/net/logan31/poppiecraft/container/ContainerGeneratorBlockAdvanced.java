...
import net.logan31.poppiecraft.container.Slots.SlotAdvancedSpirit;
import net.logan31.poppiecraft.container.Slots.SlotAdvancedUpgrade;
 ...
 */
public class ContainerGeneratorBlockAdvanced extends Container {
    ...
    public ContainerGeneratorBlockAdvanced(IInventory playerInv, TileEntityGeneratorBlockAdvanced te) {
        ...
        this.addSlotToContainer(new SlotAdvancedSpirit(handler, 19, 62, 8));
        this.addSlotToContainer(new SlotAdvancedSpirit(handler, 20, 80, 8));
        this.addSlotToContainer(new SlotAdvancedSpirit(handler, 21, 98, 8));
        this.addSlotToContainer(new SlotAdvancedUpgrade(handler, 22, 152, 8));
