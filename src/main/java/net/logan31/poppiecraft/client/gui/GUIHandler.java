...
public class GUIHandler implements IGuiHandler {
    ...
    public Object getServerGuiElement(int ID, EntityPlayer player, World world, int x, int y, int z) {
        ...
        switch(ID) {
            ...
            case MELTER:
                return new ContainerFoundry(player.inventory, (TileEntityFoundry) world.getTileEntity(new BlockPos(x, y, z)));
    ...
    public Object getClientGuiElement(int ID, EntityPlayer player, World world, int x, int y, int z) {
        switch (ID) {
            ...
            case MELTER:
                return new GUIFoundry( player.inventory, (TileEntityFoundry) world.getTileEntity( new BlockPos( x, y, z ) ) );
