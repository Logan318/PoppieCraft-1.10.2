...
public class ModRecipes {
    ...
    public void registerCraftRecipes() {
        ...
        GameRegistry.addShapedRecipe(new ItemStack(ModBlocks.Generator_block_basic, 1, 0), new Object[]{"CDC", "DBD", "CDC", 'C', Blocks.COAL_BLOCK, 'D', ModItems.Pironnite_ingot, 'B', ModItems.Generator_power});
        GameRegistry.addShapedRecipe(new ItemStack(ModBlocks.Generator_block_advanced, 1, 1), new Object[]{"CDC", "DBD", "CDC", 'C', Blocks.LAPIS_BLOCK, 'D', ModItems.Poppie_ingot, 'B', new ItemStack(ModBlocks.Generator_block_basic, 1, 0)});
        GameRegistry.addShapedRecipe(new ItemStack(ModBlocks.Generator_block_ultimate, 1, 2), new Object[]{"CDC", "DBD", "CDC", 'C', Blocks.DIAMOND_BLOCK, 'D', ModItems.Steel_ingot, 'B', new ItemStack(ModBlocks.Generator_block_advanced, 1, 1)});

        GameRegistry.addShapedRecipe(new ItemStack(ModItems.Broken_basic_spirit_power), new Object[]{"EPE", "CDC", "IEI", 'E', Items.EMERALD, 'P', Items.ENDER_PEARL, 'I', ModBlocks.Compressed_iron_block, 'C', ModBlocks.Compressed_carbon_block, 'D', Blocks.DIAMOND_BLOCK});
