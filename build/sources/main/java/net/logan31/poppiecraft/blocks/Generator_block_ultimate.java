...
public class Generator_block_ultimate extends Block implements ITileEntityProvider{

    public static final PropertyDirection FACING = PropertyDirection.create( "facing");
    public static final PropertyBool ACTIVATED = PropertyBool.create("activated");


    public Generator_block_ultimate(String name) {
        super(Material.IRON);
    ...
    public TileEntity createTileEntity(World world, IBlockState state) {
        return new TileEntityGeneratorBlockUltimate();
    }
    ...
    public void breakBlock(World world, BlockPos pos, IBlockState state) {
        TileEntityGeneratorBlockUltimate te = (TileEntityGeneratorBlockUltimate) world.getTileEntity(pos);
    ...
    public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, @Nullable ItemStack heldItem, EnumFacing side, float hitX, float hitY, float hitZ) {
        if(!worldIn.isRemote) {
            playerIn.openGui(PoppieCraftMod.instance, GUIHandler.GENERATOR_BLOCK_ULTIMATE, worldIn, pos.getX(), pos.getY(), pos.getZ() );
        }
